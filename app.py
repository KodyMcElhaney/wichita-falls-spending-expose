...
st.markdown("**Citizen tracking of where your tax dollars are going**")
...
df["Change %"] = ((df["2026"] - df["2022"]) / df["2022"] * 100).round(1)
...
st.info("📍 This is a demo dashboard using sample data. We'll load real check register data soon.")
